...
public class Lesson7 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Распечатать массив catsAges");
        System.out.println(catsAges);
        System.out.println(catsAges1);

        // Распечатать массив catsAges с помощью класса Arrays
        System.out.println("Распечатать массив catsAges с помощью класса Arrays");
        ...
        System.out.println("Заполнить массив catsNames значениями");
        catsNames = new String[]{"Дымка", "Черныш", "Кокос", "Васька", "Рыжик", "Снежок", "Братиш", "Матроскин"};


        //Распечатать массив catsNames
        System.out.println("Распечатать массив catsNames");
        System.out.println(Arrays.toString(catsNames));

        System.out.println("Заполнить массив catsAges значениями");
        ...
        System.out.println("Распечатать значения, лежащие в ячейках 0, 7 массива catsNames");
